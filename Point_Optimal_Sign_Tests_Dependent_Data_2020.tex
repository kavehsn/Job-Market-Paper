...
\begin{equation*}
\begin{tabular}{l}
$\tilde{a}_{t}(\bm{\beta} _{0}\mid\bm{\beta}_{1})=\ln\left\{ \frac{1-\frac{\bm{\mathcal{T}}_{\nu}((\bm{\beta}_0-\bm{\beta}_1)'\bm{x}_{t-1},(\bm{\beta}_0-\bm{\beta}_1)'\bm{x}_{t-2} ) }{1-\tau_{\nu}\left(\left(\bm{\beta}_1-\bm{\beta}_0\right)'\bm{x}_{t-2}\right)}}{\frac{\bm{\mathcal{T}}_{\nu}((\bm{\beta}_0-\bm{\beta}_1)'\bm{x}_{t-1},(\bm{\beta}_0-\bm{\beta}_1)'\bm{x}_{t-2} )}{1-\tau_{\nu}\left(\left(\bm{\beta}_1-\bm{\beta}_0\right)'\bm{x}_{t-2}\right)}}\right\} 
$ ,\\ 
\\ 
$\tilde{b}_{t}(\bm{\beta} _{0}\mid\bm{\beta} _{1})=\ln \left\{ \frac{1-\left( \frac{1-\tau_{\nu}\left(\left(\bm{\beta}_1-\bm{\beta}_0\right)'\bm{x}_{t-1}\right) }{\tau_{\nu}\left(\left(\bm{\beta}_1-\bm{\beta}_0\right)'\bm{x}_{t-2}\right)}-\frac{\bm{\mathcal{T}}_{\nu}((\bm{\beta}_0-\bm{\beta}_1)'\bm{x}_{t-1},(\bm{\beta}_0-\bm{\beta}_1)'\bm{x}_{t-2} )}{\tau_{\nu}\left(\left(\bm{\beta}_1-\bm{\beta}_0\right)'\bm{x}_{t-2}\right) }\right) }{\frac{1-\tau_{\nu}\left(\left(\bm{\beta}_1-\bm{\beta}_0\right)'\bm{x}_{t-1}\right)}{\tau_{\nu}\left(\left(\bm{\beta}_1-\bm{\beta}_0\right)'\bm{x}_{t-2}\right)}-\frac{\tau_{\nu}((\bm{\beta}_0-\bm{\beta}_1)'\bm{x}_{t-1},(\bm{\beta}_0-\bm{\beta}_1)'\bm{x}_{t-2} ) }{\tau_{\nu}\left(\left(\bm{\beta}_1-\bm{\beta}_0\right)'\bm{x}_{t-2}\right)}}\right\}-\ln \left\{ \frac{1-\frac{\tau_{\nu}((\bm{\beta}_0-\bm{\beta}_1)'\bm{x}_{t-1},(\bm{\beta}_0-\bm{\beta}_1)'\bm{x}_{t-2} ) }{1-\tau_{\nu}\left(\left(\bm{\beta}_1-\bm{\beta}_0\right)'\bm{x}_{t-2}\right) }}{\frac{\tau_{\nu}((\bm{\beta}_0-\bm{\beta}_1)'\bm{x}_{t-1},(\bm{\beta}_0-\bm{\beta}_1)'\bm{x}_{t-2} )}{1-\tau_{\nu}\left(\left(\bm{\beta}_1-\bm{\beta}_0\right)'\bm{x}_{t-2}\right)}}\right\}, 
$%
\end{tabular}%
\end{equation*}%
