...
\]
We define the vector of signs $U(T)=(s(y_1),\cdots,s(y_T))'$, where $s(y_t)=\mathbbm{1}_{\mathbb{R}^+\cup 0}\{y_t\}$. Thus, the likelihood function of the sample in terms of signs under the null hypothesis is
\begingroup
\allowdisplaybreaks
\begin{align*}
